...
def process_raster_data(event_data: dict) -> str:
    ...
    create_query = """
                   CREATE TABLE IF NOT EXISTS `YOUR_PROJECT_ID.YOUR_DATASET.YOUR_TABLE` (
                                                                                            id           INT64,
                                                                                            Area         GEOGRAPHY,
    ...
    merge_query = f"""
    MERGE `YOUR_PROJECT_ID.YOUR_DATASET.YOUR_TABLE` T
    USING (
      SELECT
        id,
        Area,
      ...
      FROM `YOUR_PROJECT_ID.YOUR_SOURCE_DATASET.YOUR_SOURCE_TABLE`
    ) S
